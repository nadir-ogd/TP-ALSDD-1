...
{   int y;
  ...
  //**********************************************************************************************************************
   ...
   // printdirection("Ecole Nationale Superieur en Informatique d'Alger ","right",40,1,30);
    ...
    textcolor(9);
    gotoxy(35,12);
    printf("%c%c%c%c%c%c%c%c%c%c         %c%c%c%c%c%c%c%c%c             %c%c%c%c\n",219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219) ;delay(50);gotoxy(35,13);
    printf("    %c%c             %c%c     %c%c               %c%c\n",219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219);delay(50);gotoxy(35,14);
    printf("    %c%c             %c%c     %c%c               %c%c\n",219,219,219,219,219,219,219,219,219,219);delay(50);gotoxy(35,15);
    printf("    %c%c             %c%c%c%c%c%c%c%c%c               %c%c\n",219,219,219,219,219,219,219,219,219,219,219,219,219);delay(50);gotoxy(35,16);
   ...
   /* delay(300);
    ...
    textbackground(0);
    textcolor(15);
    printdirection("<< RECENEMENT D'UNE POPULATION >>","right",73,25,30);
    textbackground(0);
    printdirection("> ENCADRE PAR :","right",20,27,25);
    textbackground(0);
    textcolor(9);
    printdirection("Dr A.Kermi ","right",50,27,25);
...
int choix_1 (void)
{   int i,x=0,y=0,ch;
    chaine lechoix[]={ "   >>    Creer une nouvelle liste de population   <<  ",
...
{   int i,x=0,y=0,ch;
    chaine lechoix[]={ "   >>              Creer une nouvelle liste de population               <<  ",
                       "   >>          Afficher le nombre de familles sans parent(s)            <<  ",
                       "   >>           Afficher le nombre d'enfant de la population            <<  ",
                       "   >>            Afficher le nombre d'enfants d'une famille             <<  ",
                       "   >>               Ajouter un nouveau ne a une famille                 <<  ",
                       "   >>    Retrouver l'adresse de la famille possedant la voiture volee   <<  ",
                       "   >>                        Afficher la liste                          <<  ",
                       "   >>                               Exit                                <<  ",};
...
{   int i,y,a=0,z,d,b;
    ...
    */
    ...
    b=0;  textbackground(b);*/
          ...
          printdirection("                                                                \n","left",z,d+8,0);textbackground(15);
          printdirection("                                                                \n","left",z,d+9,0);textbackground(15);
}


int choix_partie (void)
{   int i,x=0,y=0,ch;
    chaine lechoix[]={ "   >>         PREMIERE PARTIE         <<  ",
                       "   >>         DEUXIEME PARTIE         <<  ",
                       "   >>               Exit              <<  ",};
